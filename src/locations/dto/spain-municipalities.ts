// Auto-generated from https://github.com/codeforspain/ds-organizacion-administrativa
// Do not edit by hand; regenerate from source data if updates are needed.
...
export function getMunicipalitiesByProvince(provinceCode: string): string[] {
  return MUNICIPALITIES_BY_PROVINCE[provinceCode.toUpperCase()] ?? [];
}
